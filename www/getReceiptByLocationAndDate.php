...
// check for post data
if (isset($_GET["Location_idLocation"]) && isset($_GET["ReceiptDate"])) {
	
    $Location_idLocation = $_GET['Location_idLocation'];
    $ReceiptDate = $_GET['ReceiptDate'];
 
    // get a receipt from receipts table
    $result = mysql_query("select idReceipt, ReceiptFile, Location_idLocation, ReceiptDate, ReceiptAmount, ReceiptNotes, create_time, update_time from Receipt where Location_idLocation=$Location_idLocation and ReceiptDate=$ReceiptDate");
